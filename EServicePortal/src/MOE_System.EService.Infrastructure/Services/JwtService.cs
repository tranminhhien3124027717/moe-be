...
public class JwtService : IJwtService
{
    ...
    public string GenerateToken(string educationAccountId, string accountHolderId, string userName, string email)
    {
        ...
        var claims = new[]
        {
            ...
            new Claim("EducationAccountId", educationAccountId),
